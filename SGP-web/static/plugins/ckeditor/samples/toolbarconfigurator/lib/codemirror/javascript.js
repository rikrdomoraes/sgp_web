(function (p) { typeof exports === 'object' && typeof module === 'object' ? p(require('../../lib/codemirror')) : typeof define === 'function' && define.amd ? define(['../../lib/codemirror'], p) : p(CodeMirror) })(function (p) {
  p.defineMode('javascript', function (oa, t) {
    function q (a, c, e) { E = a; I = e; return c } function w (a, c) {
      ...
      return function (c,
e) { var d = !1, b; if (L && c.peek() == '@' && c.match(qa)) return e.tokenize = w, q('jsonld-keyword', 'meta'); for (;(b = c.next()) != null && (b != a || d);)d = !d && b == '\\'; d || (e.tokenize = w); return q('string', 'string') }
...
null); var e = a.string.indexOf('\x3d\x3e', a.start); if (!(e < 0)) { for (var d = 0, b = !1, e = e - 1; e >= 0; --e) { var f = a.string.charAt(e), g = '([{}])'.indexOf(f); if (g >= 0 && g < 3) { if (!d) { ++e; break } if (--d == 0) break } else if (g >= 3 && g < 6)++d; else if (R.test(f))b = !0; else { if (/["'\/]/.test(f)) return; if (b && !d) { ++e; break } } }b && !d && (c.fatArrowAt = e) }
    ...
    function b () { g.apply(null, arguments); return !0 } function x (a) { function c (c) { for (;c; c = c.next) if (c.name == a) return !0; return !1 } var b = f.state; b.context ? (f.marked = 'def', c(b.localVars) || (b.localVars = {name: a, next: b.localVars})) : !c(b.globalVars) && t.globalVars && (b.globalVars = {name: a, next: b.globalVars}) } function y () { f.state.context = {prev: f.state.context, vars: f.state.localVars}; f.state.localVars = ra } function z () { f.state.localVars = f.state.context.vars; f.state.context = f.state.context.prev } function l (a, c) {
      var b = function () {
        var b =
f.state, e = b.indented; if (b.lexical.type == 'stat')e = b.lexical.indented; else for (var h = b.lexical; h && h.type == ')' && h.align; h = h.prev)e = h.indented; b.lexical = new ca(e, f.stream.column(), a, null, b.lexical, c)
      }; b.lex = !0; return b
...
F(V, ')'), k, r, z)
  ...
  return a == ']'
? b() : g(u, Ka)
} function Ka (a) { return a == 'for' ? g(N, m(']')) : a == ',' ? b(F(ia, ']')) : g(F(u, ']')) } function N (a) { if (a == 'for') return b(ea, N); if (a == 'if') return b(n, N) } var C = oa.indentUnit, na = t.statementIndent, L = t.jsonld, D = t.json || L, ka = t.typescript, R = t.wordCharacters || /[\w$\xa1-\uffff]/, ba = (function () {
    function a (a) { return {type: a, style: 'keyword'} } var c = a('keyword a'), b = a('keyword b'), d = a('keyword c'), f = a('operator'), h = {type: 'atom', style: 'atom'}, c = {'if': a('if'),
        'while': c,
        'with': c,
        'else': b,
        'do': b,
    ...
    next: {name: 'arguments'}}; k.lex = !0; return {startState: function (a) { a = {tokenize: w, lastType: 'sof', cc: [], lexical: new ca((a || 0) - C, 0, 'block', !1), localVars: t.localVars, context: t.localVars && {vars: t.localVars}, indented: 0}; t.globalVars && typeof t.globalVars === 'object' && (a.globalVars = t.globalVars); return a },
      token: function (a, b) {
        ...
        b.lastType = E != 'operator' || I != '++' && I != '--' ? E : 'incdec'; a: { var d = E, g = I, h = b.cc; f.state = b; f.stream = a; f.marked = null; f.cc = h; f.style = e; b.lexical.hasOwnProperty('align') || (b.lexical.align = !0); for (;;) if ((h.length ? h.pop() : D ? n : r)(d, g)) { for (;h.length && h[h.length - 1].lex;)h.pop()(); if (f.marked) { e = f.marked; break a } if (d = d == 'variable')b: { for (d = b.localVars; d; d = d.next) if (d.name == g) { d = !0; break b } for (h = b.context; h; h = h.prev) for (d = h.vars; d; d = d.next) if (d.name == g) { d = !0; break b }d = void 0 } if (d) { e = 'variable-2'; break a } break a } } return e
      },
      indent: function (a, b) {
