...
CKEDITOR.dialog.add('specialchar', function (k) {
  var e, n = k.lang.specialchar, m = function (c) { var b; c = c.data ? c.data.getTarget() : new CKEDITOR.dom.element(c); c.getName() == 'a' && (b = c.getChild(0).getHtml()) && (c.removeClass('cke_light_background'), e.hide(), c = k.document.createElement('span'), c.setHtml(b), k.insertText(c.getText())) }, p = CKEDITOR.tools.addFunction(m), l, g = function (c, b) {
      var a; b = b || c.data.getTarget(); b.getName() == 'span' && (b = b.getParent()); if (b.getName() == 'a' && (a = b.getChild(0).getHtml())) {
        l && d(null, l)
      ...
      b = b || c.data.getTarget(); b.getName() == 'span' && (b = b.getParent()); b.getName() == 'a' && (e.getContentElement('info', 'charPreview').getElement().setHtml('\x26nbsp;'), e.getContentElement('info', 'htmlPreview').getElement().setHtml('\x26nbsp;'), b.getParent().removeClass('cke_light_background'),
l = void 0)
    }, q = CKEDITOR.tools.addFunction(function (c) {
      c = new CKEDITOR.dom.event(c); var b = c.getTarget(), a; a = c.getKeystroke(); var f = k.lang.dir == 'rtl'; switch (a) {
        case 38:if (a = b.getParent().getParent().getPrevious())a = a.getChild([b.getParent().getIndex(), 0]), a.focus(), d(null, b), g(null, a); c.preventDefault(); break; case 40:(a = b.getParent().getParent().getNext()) && (a = a.getChild([b.getParent().getIndex(), 0])) && a.type == 1 && (a.focus(), d(null, b), g(null, a)); c.preventDefault(); break; case 32:m({data: c}); c.preventDefault()
          break; case f ? 37 : 39:if (a = b.getParent().getNext())a = a.getChild(0), a.type == 1 ? (a.focus(), d(null, b), g(null, a), c.preventDefault(!0)) : d(null, b); else if (a = b.getParent().getParent().getNext())(a = a.getChild([0, 0])) && a.type == 1 ? (a.focus(), d(null, b), g(null, a), c.preventDefault(!0)) : d(null, b); break; case f ? 39 : 37:(a = b.getParent().getPrevious()) ? (a = a.getChild(0), a.focus(), d(null, b), g(null, a), c.preventDefault(!0)) : (a = b.getParent().getParent().getPrevious()) ? (a = a.getLast().getChild(0), a.focus(), d(null, b), g(null, a), c.preventDefault(!0))
: d(null, b)
      }
      ...
      contents: [{id: 'info',
        ...
        elements: [{type: 'hbox',
          ...
          children: [{type: 'html',
            ...
            onMouseover: g,
            onMouseout: d,
            focus: function () { var c = this.getElement().getElementsByTag('a').getItem(0); setTimeout(function () { c.focus(); g(null, c) }, 0) },
            onShow: function () {
              var c = this.getElement().getChild([0,
              0, 0, 0, 0]); setTimeout(function () { c.focus(); g(null, c) }, 0)
            },
            onLoad: function (c) { e = c.sender }}, {type: 'hbox',
              align: 'top',
              widths: ['100%'],
              children: [{type: 'vbox',
              align: 'top',
