...
CKEDITOR.dialog.add('a11yHelp', function (l) {
  var a = l.lang.a11yhelp, n = CKEDITOR.tools.getNextId(), e = {8: a.backspace,
      9: a.tab,
      13: a.enter,
      16: a.shift,
      17: a.ctrl,
      ...
      222: a.singleQuote}; e[CKEDITOR.ALT] = a.alt; e[CKEDITOR.SHIFT] = a.shift; e[CKEDITOR.CTRL] = a.ctrl; var f = [CKEDITOR.ALT, CKEDITOR.SHIFT,
          CKEDITOR.CTRL], p = /\$\{(.*?)\}/g, t = (function () { var a = l.keystrokeHandler.keystrokes, g = {}, c; for (c in a)g[a[c]] = c; return function (a, c) { var b; if (g[c]) { b = g[c]; for (var h, k, m = [], d = 0; d < f.length; d++)k = f[d], h = b / f[d], h > 1 && h <= 2 && (b -= k, m.push(e[k])); m.push(e[b] || String.fromCharCode(b)); b = m.join('+') } else b = a; return b } }()); return {title: a.title,
            minWidth: 600,
            minHeight: 400,
            contents: [{id: 'info',
