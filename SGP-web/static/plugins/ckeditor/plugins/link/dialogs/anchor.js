...
CKEDITOR.dialog.add('anchor', function (c) {
  function d (a, b) { return a.createFakeElement(a.document.createElement('a', {attributes: b}), 'cke_anchor', 'anchor') } return {title: c.lang.link.anchor.title,
    ...
    minHeight: 60,
    onOk: function () {
      var a = CKEDITOR.tools.trim(this.getValueOf('info', 'txtName')), a = {id: a, name: a, 'data-cke-saved-name': a}; if (this._.selectedElement) {
...
: this._.selectedElement.setAttributes(a)
      } else { var b = c.getSelection(), b = b && b.getRanges()[0]; b.collapsed ? (a = d(c, a), b.insertNode(a)) : (CKEDITOR.env.ie && CKEDITOR.env.version < 9 && (a['class'] = 'cke_anchor'), a = new CKEDITOR.style({element: 'a', attributes: a}), a.type = CKEDITOR.STYLE_INLINE, c.applyStyle(a)) }
    },
