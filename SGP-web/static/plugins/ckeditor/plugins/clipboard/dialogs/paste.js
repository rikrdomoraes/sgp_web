...
9:this.changeFocus(1), b = 1
  ...
  } var h = c.lang.clipboard, e = CKEDITOR.plugins.clipboard, f; c.on('pasteDialogCommit', function (a) { a.data && c.fire('paste', {type: 'auto', dataValue: a.data.dataValue, method: 'paste', dataTransfer: a.data.dataTransfer || e.initPasteDataTransfer()}) }, null, null, 1E3); return {title: h.title,
    minWidth: CKEDITOR.env.ie && CKEDITOR.env.quirks ? 370
: 350,
    minHeight: CKEDITOR.env.quirks ? 250 : 245,
    onShow: function () { this.parts.dialog.$.offsetHeight; this.setupContent(); this.parts.title.setHtml(this.customTitle || h.title); this.customTitle = null },
    onLoad: function () { (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) && c.lang.dir == 'rtl' && this.parts.contents.setStyle('overflow', 'hidden') },
...
h.securityMsg + '\x3c/div\x3e'}, {type: 'html', id: 'pasteMsg', html: '\x3cdiv style\x3d"white-space:normal;width:340px"\x3e' + h.pasteMsg + '\x3c/div\x3e'}, {type: 'html',
  ...
  html: '',
  focus: function () { var a = this.getInputElement(), b = a.getFrameDocument().getBody(); !b || b.isReadOnly() ? a.setCustomData('pendingFocus', 1) : b.focus() },
  setup: function () {
