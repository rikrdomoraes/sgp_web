...
<script>
  ...
  export default {
    ...
    async created () {
      ...
      axiosLaravel.post('apieditais/processos/historico/', {'id_proposta': atob(this.$route.params.id), 'tipo': 'USUARIO'}).then((response) => {
        ...
        axiosLaravel.get('apieditais/propostas/' + atob(this.$route.params.id) + '?token=zy47ULqcilUO1MS3SJR43zGsukVDhUvZG6MzrImYyeYgbhthkmO33S9TuX1RR30f').then((response) => {
    ...
    methods: {
      ...
      async buscaEntidades () {
        ...
        await axiosLaravel.get('apieditais/entidades/' + this.proposta.entidade.id + '?token=zy47ULqcilUO1MS3SJR43zGsukVDhUvZG6MzrImYyeYgbhthkmO33S9TuX1RR30f').then(async (response) => {
      ...
      buscaFluxo () {
        ...
        axiosLaravel.post('apieditais/fluxo/', {'id_proposta': atob(this.$route.params.id), 'atividade': 'SOLICITACAO'}).then((response) => {
