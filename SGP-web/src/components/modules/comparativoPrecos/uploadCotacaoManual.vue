<template>
  ...
  <div>
    <b>(Adicione os documentos referentes ao item abaixo)</b>
    <!-- form de documentos-->
    ...
    <div v-if="showGrid">
      ...
      <div class="row" v-if="!disable">
        ...
        <div class="col-sm-12" v-if="faseProposta !== 'FORMALIZACAO' && faseProposta !== 'APROVACAO_PROJETO' && faseProposta !== 'APROVACAO'">
          <button v-if="propDocumentos.length < maxFiles" @click="novoDocumento" type="button" class="btn btn-primary btn-flat"><i class="fa fa-plus-circle" aria-hidden="true"></i> Novo documento </button>
          ...
          <div class="table-responsive">
            <table class="table table-condensed table-bordered table-striped">
              ...
              <tr v-for="(documento, indexDocumento) in propDocumentos" :value="documento" :key="indexDocumento"
                ...
                <td v-if="!disable">
                  <button v-if="!disable && !PropProrrogacaoEdit" v-show="faseProposta !== 'APROVACAO_PROJETO' && faseProposta !== 'APROVACAO'" type="button" @click="editaDocumento(documento, indexDocumento)"
                  ...
                  <button v-if="!disable && !PropEditandoAlteracaoProjeto" type="button" v-show="faseProposta !== 'FORMALIZACAO' && faseProposta !== 'APROVACAO_PROJETO' && faseProposta !== 'APROVACAO'"
