...
export default {
  ...
  methods: {
    ...
    async buscaDefinicoesGravadas () {
      this.loading.show = true
      await axiosLaravel.get('/definicaoparticipante/getPrevistosProjeto/' + this.proposta).then((response) => {
    ...
    async buscaDefinicoesParticipante () {
      this.loading.show = true
      await axiosLaravel.get('/definicaoparticipante/getRealizadosParticipante/' + this.idParticipante).then((response) => {
        this.definicoes = response.data
        console.log(this.definicoes)
        this.defAux = this.definicoes.slice()
        this.initCheckbox()
        this.loading.show = false
        this.$forceUpdate()
