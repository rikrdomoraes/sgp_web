        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="box-body" ><div class="overlay" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; display: none;"><i class="fa fa-refresh fa-spin"></i></div>
              <form name="user" class="form-horizontal ng-pristine ng-valid-maxlength ng-valid-minlength ng-valid-mask ng-valid-parse ng-valid-date ng-valid-max ng-valid ng-valid-required" novalidate="" style="">
                ...
                <div v-if="this.$root.authorize('perfil-novo')" class="ng-scope ng-isolate-scope"><fieldset>
                  ...
                  <div class="form-group">
                    <div class="col-sm-8">
                      <g-button-ujarak color="dark-primary"  @click.native="onAdd" size="button--size-ss"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-plus-circle" aria-hidden="true"></i> Atribuir </g-button-ujarak>
                    </div>
                  </div>
                        ...
                        >
                          <template slot="actions" scope="row">
                            <div>
                              ...
                              <!--<g-button-ujarak color="primary" size="button&#45;&#45;size-ss" @click="onEdit(row)" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp Editar</g-button-ujarak >-->
                              <!--<g-button-ujarak color="error" size="button&#45;&#45;size-ss" @click="onDelete(row)" ><i class="fa fa-trash" aria-hidden="true"></i>&nbsp Excluir</g-button-ujarak >-->
              ...
              <div class="col-sm-12">
                <g-button-moema color="success" size="button--size-ss" @click.native="onSave"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Salvar</g-button-moema>
...
<script>
  export default {
    ...
    created () {
      this.favs = this.$route.params.fav
      this.fav = this.$route.params.fav
      this.table2.items = this.favs.favQuestions
      // this.carregaFav()
    },
    methods: {
      onNew () {
      ...
      onEdit (row) {
        ...
        // this.fav.favQuestions.push(Object.assign({}, this.questao))
        this.show = true
      },
      onDelete (row) {
        this.editandoIndex = null
      ...
      atualiza () {
        axios.put('/proxy/project/favs/' + this.fav.id, this.fav).then((response) => {
