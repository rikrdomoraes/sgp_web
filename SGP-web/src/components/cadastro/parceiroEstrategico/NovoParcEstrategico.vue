      ...
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="col-md-12">
                <form name="frmCommonRegister" class="form-horizontal" novalidate>
                  <div class="col-md-7 col-lg-6" id="cadastroJuri">
                    <fieldset :disabled="!isEditable()">
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Razão social')}">
                        ...
                        <div class="col-md-8">
                          <input v-model="parceiro.companyName" name="Razão social" class="form-control" type="text" ref="Razão social" v-validate="'required|min:1|max:255'">
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('CNPJ')}">
                        ...
                        <div class="col-md-6 col-lg-4">
                          <the-mask v-model="parceiro.cnpj" name="CNPJ" class="form-control" type="text"
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('cnpjExpeditionTime')}">
                        ...
                        <div class="col-md-6 col-lg-4">
                          <div class="input-group">
                            <datepicker  ref="cnpjExpeditionTime" name="cnpjExpeditionTime" v-model="parceiro.cnpjExpeditionTime"  input-class="form-control datepicker"
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Nome fantasia')}">
                        ...
                        <div class="col-md-8">
                          <input v-model="parceiro.businessName" name="Nome fantasia" ref="Nome fantasia" class="form-control" type="text" v-validate="'required|min:1|max:255'">
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Natureza jurídica')}">
                        ...
                        <div class="col-md-8">
                          <select v-model="parceiro.legalType" name="Natureza jurídica" class="form-control" v-validate="'required'" ref="Natureza jurídica">
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Ramo atividade')}">
                        ...
                        <div class="col-md-8">
                          <select v-model="parceiro.activity" class="form-control" name="Ramo atividade"
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Doc. constituição')}">
                        ...
                        <div class="col-md-8">
                          <select v-model="parceiro.constitutionDocument" name="Doc. constituição" class="form-control" v-validate="'required'" ref="Doc. constituição">
                    ...
                    <fieldset >
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Telefone')}">
                        ...
                        <div class="col-md-8 col-lg-4">
                          <input v-model="parceiro.phone" v-mask="'(##) ####-#####'" :masked="masked" name="Telefone" class="form-control" type="text" v-validate="'required|min:1'" ref="Telefone">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-lg-4">
                          <input v-model="parceiro.mobile" v-mask="'(##) #####-#####'" :masked="masked" name="mobile" class="form-control" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Email')}">
                        ...
                        <div class="col-md-8">
                          <input v-model="parceiro.email" name="Email" class="form-control" type="text" delivery="account" method="uniqueUserEmail" v-validate="'required|min:1|max:255'" ref="Email">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input v-model="parceiro.website" name="website" class="form-control" type="text" v-validate="'max:255'">
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <endereco :entEnderecos="enderecos"></endereco>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <usuarios :entUsuarios="usuarios"></usuarios>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <upload-documentos :propDocumentos="parceiro.documents" :documentTypes="parceiro.documentTypes"></upload-documentos>
                    </div>
                  </div>
          ...
          <div class="box-footer">
            <button @click="conclui(frmCommonRegister)" :disabled="!isEditable()" uib-tooltip="Conclui o cadastro" type="button" class="btn btn-success btn-flat"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Concluir</button>
            <button @click="salva(frmCommonRegister)"  :disabled="!isEditable()"  uib-tooltip="Apenas salva o cadastro" type="button" class="btn btn-default btn-flat"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Salvar</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      outrasValidacoes () {
        if (!this.parceiro.chiefs || this.parceiro.chiefs === 0) {
      ...
      salvaUsuarios () {
        axios.post('proxy/account/strategicpartners/' + this.parceiro.id + '/users', this.usuarios).then((response) => {
      ...
      conclui () {
        ...
        if ((this.parceiro.status === 'PENDENTE_APROVACAO')) {
          parceiroOK = true
        }
        if (parceiroOK) {
          this.$validator.validateAll().then((result) => {
            if (result) {
              ...
              if (this.parceiro.id) {
                axios.put('proxy/account/strategicpartners/' + this.parceiro.id, this.parceiro).then((response) => {
                  this.salvaUsuarios()
                })
                  .catch((error) => {
                    this.$root.trataErro(error)
                ...
                axios.post('proxy/account/strategicpartners/temp/', this.parceiro).then((response) => {
                })
              }
              if (this.parceiro.active === false) {
                this.$snotify.success('Cadastro da parceiro concluído com sucesso! Aguarde e-mail da Fundação Banco do brasil com as informações para dar continuidade ao processo !')
                setTimeout(() => {
                  this.$router.go(-1)
                }, 2000)
              } else {
      ...
      loadHistory () {
        axios.get('proxy/account/strategicpartners/' + this.parceiro.id + '/history').then((response) => {
      ...
      atualiza () {
        ...
        axios.put('/proxy/account/strategicpartners/' + this.parceiro.id + '/temp', this.parceiro).then((response) => {
          this.salvaUsuarios()
      ...
      grava () {
        axios.post('proxy/account/strategicpartners/temp', this.parceiro).then((response) => {
          this.$snotify.success('Parceiro atualizado com sucesso!')
        })
      }
    }
  }
