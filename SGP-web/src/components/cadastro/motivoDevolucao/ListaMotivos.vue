<template>
  <div class="content-wrapper" style="min-height: 870px;">
    ...
    <vue-headful :title="'SGP - Lista Motivos de Devolução'"/>
          ...
          <div class="col-md-12">
            <div class="ng-scope ng-isolate-scope"><div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-list" aria-hidden="true"></i> Lista Motivos de Devolução</h3>
              </div>
              <div class="box-body" >
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <g-button-ujarak color="dark-primary" v-if="this.$root.authorize('motivo-devolucao-criar')" @click.native="$router.push({name: 'cadastro-motivos-edita'})" size="button--size-ss"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-plus-circle" aria-hidden="true"></i> Novo Motivo de Devolução </g-button-ujarak>
                  </div>
                  <!--</div>-->
                  <!--Campo de pesquisa-->
                    ...
                    <b-container fluid>
                      ...
                      >
                        ...
                        <template slot="actions" scope="row">
                          <div>
                            <b-button type="button" :disabled="false" :to="{name: 'cadastro-motivos-edita', params: { id: row.item.id }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</b-button>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        table: {
          ...
          totalRows: null,
          fields: [
            { key: 'codigo', label: 'Código', sortable: true, thStyle: 'text-align: center; width: 10%', class: 'text-center' },
            { key: 'descricao', label: 'Descrição', sortable: true, thStyle: 'text-align: center; width: 30%', class: 'text-center' },
    ...
    created () {
      ...
      axiosLaravel.get('motivos/').then((response) => {
    ...
    methods: {
      ...
      inativa (item) {
        this.loading.show = true
        axiosLaravel.delete('motivos/' + item.id).then((response) => {
          this.$snotify.success('Motivo ' + item.codigo + ' atualizado com sucesso!')
