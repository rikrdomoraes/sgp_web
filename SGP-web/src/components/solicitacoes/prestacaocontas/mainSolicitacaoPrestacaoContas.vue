<template>
  <div>
            ...
            <div  class="col-md-12 form-horizontal">
              <div class="ng-scope ng-isolate-scope"><div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-pencil" aria-hidden="true"></i> Solicitação de Prestação de Contas</h3>
                </div>
                <div class="box-body" >
    ...
    <div v-if="visibleForm">
      ...
      <form-solicitacao-prestacao-contas :propsNota="nota" :propsValidacao="validacao" :propsProjeto="projeto" @voltaPraSolicitacao="voltaPraSolicitacao" @concluiValidacaoNota="concluiValidacaoNota($event)"></form-solicitacao-prestacao-contas>
    </div>
...
<script>
  ...
  import FormSolicitacaoPrestacaoContas from '../../solicitacoes/prestacaocontas/formSolicitacaoPrestacaoContas'
  import { mapGetters } from 'vuex'
  import moment from 'moment'

  export default {
    components: {
      FormSolicitacaoPrestacaoContas,
      DownloadNotas},
    name: 'main-solicitacao-prestacao-contas',
    data () {
      return {
        modalShow: false,
    ...
    methods: {
      ...
      buscaProjetos () {
        ...
        axiosLaravel.post('processos/projetos', {processo: 'PRESTACAO_DE_CONTAS'}).then((response) => {
      ...
      onConclude () {
        this.$validator.validateAll().then(result => {
          if (result) {
            ...
            // console.log('objeto backend', this.validacao)
