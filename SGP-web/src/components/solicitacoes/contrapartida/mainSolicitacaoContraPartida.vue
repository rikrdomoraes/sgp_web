<template>
  <div>
            ...
            <div  class="col-md-12 form-horizontal">
              <div class="ng-scope ng-isolate-scope"><div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-pencil" aria-hidden="true"></i> Solicitação de Contrapartida</h3>
                </div>
                <div class="box-body" >
    ...
    <div v-if="visibleForm">
      ...
      <form-solicitacao-contrapartida :propsNota="nota" :propsValidacao="validacao" :propsProjeto="projeto" @voltaPraSolicitacao="voltaPraSolicitacao" @concluiValidacaoNota="concluiValidacaoNota($event)"></form-solicitacao-contrapartida>
    </div>
...
<script>
  ...
  import FormSolicitacaoContrapartida from '../../solicitacoes/contrapartida/formSolicitacaoContrapartida'
  import { mapGetters } from 'vuex'
  import moment from 'moment'

  export default {
    components: {
      FormSolicitacaoContrapartida,
      HistoricoSolicitacaoPagamento,
      DownloadNotas},
    name: 'main-solicitacao-contrapartida',
    data () {
      return {
        modalShow: false,
    ...
    methods: {
      ...
      buscaProjetos () {
        ...
        axiosLaravel.post('processos/projetos', {processo: 'CONTRAPARTIDA'}).then((response) => {
