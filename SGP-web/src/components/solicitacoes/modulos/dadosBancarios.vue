        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group required-field" :class="{ 'has-error' : errors.first('banco')}">
              <label for="banco" class="control-label col-md-4">Banco:</label>
              <div class="col-md-7">

                <!--<div>-->
                <!--<the-mask-->
                <!--v-model="nota.dados_bancarios.banco"-->
                <!--name="banco"-->
                <!--class="form-control text-right"-->
                <!--type="text"-->
                <!--:mask="['####']"-->
                <!--v-validate="{required: nota.formaPagamento !== 4}"-->
                <!--change="$ctrl.onChangeBank()"-->
                <!--&gt;</the-mask>-->
                <!--</div>-->
                <!-- ALTERAÇÃO REALIZADA EM 23/12/2020 POR AKIRA - SUPORTE 59454-->
                <select name="banco" class="form-control" for="banco" v-model="nota.dados_bancarios.banco">
                ...
                <span
                  v-if="errors.first('banco')"
                  class="label label-danger"
                >{{ errors.first('banco') }}</span>
              </div>
            </div>
            ...
            >
              ...
              <div class="col-md-7">
                <div>
                  <the-mask
                    v-model="nota.dados_bancarios.conta"
                    name="conta corrente"
                    class="form-control text-right"
                    type="text"
                    v-validate="'required'"
                ...
                <span
                  v-if="errors.first('conta corrente')"
                  class="label label-danger"
                >{{ errors.first('conta corrente') }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            >
              ...
              <div class="col-md-7">
                <div>
                  <the-mask
                    v-model="nota.dados_bancarios.agencia"
                    name="agência"
                    class="form-control text-right"
                    type="text"
                    :mask="['####-X']"
                    :tokens="customTokens"
                    v-validate="'required|agency'"
                    masked
                  ></the-mask>
                </div>
                <span
                  v-if="errors.first('agência')"
                  class="label label-danger"
                >{{ errors.first('agência') }}</span>
              </div>
            </div>
          </div>
        </div>
