    ...
    <div class="row" style="overflow:auto;" v-if="totais.aglutinado === 'Sim'">
      <div class="col-md-12 financial-physical-schedule">
        ...
        <table class="table table-condensed table-bordered" ref="tabelaCronogramaAglutinado">
          ...
          <tr >
            <td colspan="4" style="border-right: none;">Valor total de recursos contratados (+ Suplementado - Cancelado): </td>
            <td colspan="4" class="text-right" style="border-left: none;">{{totais.valor_total_contratado | real}}</td>
            <td></td>
          </tr>
          <tfoot style="font-weight: bold;">
          <tr >
            <td colspan="4" style="border-right: none;">Saldo restante: </td>
            <td colspan="4" class="text-right" style="border-left: none;">{{totais.saldo_restante_projeto -  total | real}}</td>
            <td></td>
          </tr>
          <tr >
            <td colspan="4" style="border-right: none;">Valor total liberado: </td>
            <td colspan="4" class="text-right" style="border-left: none;">{{totais.valor_total_contratado - totais.saldo_restante_projeto | real}}</td>
            <td></td>
          </tr>
          <tr >
          ...
          <tr >
            <td colspan="4" style="border-right: none;">Saldo restante do projeto após solicitação:	</td>
            <td colspan="4" class="text-right" style="border-left: none;">{{totais.saldo_restante_projeto -  total | real}}</td>
            <td></td>
          </tr>
          </tfoot>
      ...
      <div class="row" style="overflow:auto;">
        <div class="col-md-12 financial-physical-schedule">
          ...
          <table class="table table-condensed table-bordered">
            ...
            <tr >
              <td colspan="4" style="border-right: none;">Saldo restante: </td>
              <td colspan="4" class="text-right" style="border-left: none;">{{totais.saldo_restante_projeto | real}}</td>
              <td></td>
            </tr>
            <tr >
              <td colspan="4" bgcolor="#F0F8FF" style="border-right: none;">Valor total da solicitação:	</td>
  ...
  export default {
    ...
    methods: {
      ...
      async buscaItensProjetoBackEnd () {
        ...
        await axiosLaravel.post('processos/cronograma/projeto/', {'proposta': idProposta, 'processo': 'PAGAMENTO', 'aglutinado': 'Não', 'documento': documento}).then((response) => {
