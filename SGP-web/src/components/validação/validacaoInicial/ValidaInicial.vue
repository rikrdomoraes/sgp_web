      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <form name="frmCommonRegister" class="form-horizontal" novalidate>
                  <div class="col-md-7 col-lg-6" id="cadastroJuri">
                    <fieldset :disabled="!isEditable()">
                      ...
                      <fieldset v-if="!entidade.simplified">
                      <!-- legal type -->
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Natureza jurídica')}">
                        ...
                        <div class="col-md-8">
                          <select v-model="entidade.legalType" name="Natureza jurídica" class="form-control" v-validate="'required'" ref="Natureza jurídica">
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Ramo atividade')}">
                        ...
                        <div class="col-md-8">
                          <select v-model="entidade.activity" class="form-control" name="Ramo atividade"
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Doc. constituição')}">
                        ...
                        <div class="col-md-8">
                          <select v-model="entidade.constitutionDocument" name="Doc. constituição" class="form-control" v-validate="'required'" ref="Doc. constituição">
                    ...
                    <fieldset >
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Telefone')}">
                        ...
                        <div class="col-md-8 col-lg-4">
                          <input v-model="entidade.contact.phone" v-mask="'(##) ####-#####'" :masked="masked" name="Telefone" class="form-control" type="text" v-validate="'required|min:1'" ref="Telefone">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-lg-4">
                          <input v-model="entidade.contact.mobile" v-mask="'(##) #####-#####'" :masked="masked" name="mobile" class="form-control" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group required-field" :class="{ 'has-error' : errors.first('Email')}">
                        ...
                        <div class="col-md-8">
                          <input v-model="entidade.email" name="Email" class="form-control" type="text" delivery="account" method="uniqueUserEmail" v-validate="'required|min:1|max:255'" ref="Email">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input v-model="entidade.website" name="website" class="form-control" type="text" v-validate="'max:255'">
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <upload-documentos :propDocumentos="entidade.documents" :documentTypes="entidade.documentTypes"></upload-documentos>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-lg-12">
                  <legend>Decisões da análise da entidade:</legend>
                  <div class="col-md-12">
                    <div class="form-group required full" :class="{ 'has-error' : errors.first('resultado')}" style="margin-right:0;margin-left:0">
                      <label for="approvalResult" class="control-label">Decisões:</label>
                      <div class="col-md-12">
                        <label class="radio-inline new-control new-control-radio">
                          <input type="radio" name="resultado" id="resultado" v-model="analise.approvalResult" value="APPROVED"
                      ...
                      <div class="col-md-12">
                        <label class="radio-inline new-control new-control-radio">
                          <input  type="radio" name="resultado" v-model="analise.approvalResult" value="REVIEW_OPENED"
                      ...
                      <div class="col-md-12">
                        <label class="radio-inline new-control new-control-radio">
                          <input  type="radio" name="resultado" v-model="analise.approvalResult" value="CANCELED"
                                  v-validate="'required'"> Reprovar
                          <div class="new-control-indicator"></div>
                        </label>
                      </div>
                    ...
                    <br><br><br>
                    <!-- justify -->
                    <div v-if="analise.approvalResultt === 'REJECTED' || analise.approvalResult === 'REVIEW_OPENED'" class="form-group required full"
                      ...
                      <textarea v-model="analise.justify" style="height:150px; resize:none;" name="justificativa" id="justificativa" class="form-control"
          ...
          <div class="box-footer">
            ...
            <!--<b-button variant="warning" v-if="proposta.proposalPhase === 'CADASTRO' && proposta.simplified > 0" @click="$router.push({name: 'proposta-visualiza', params: { id: proposta.id, aprovAnt: analise.id }})" uib-tooltip="Visualiza proposta simplificada" type="button" class="btn btn-dark btn-flat">
              <i class="fa fa fa-chevron-circle-right" aria-hidden="true"></i> Visualizar proposta
            </b-button>-->
            <button @click="$router.push({ path: '/validacao/validacaoInicial/lista' })" type="button" class="btn btn-default btn-flat"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Voltar à lista</button>
          </div>
          <!-- /.box-footer -->
        </div>
        </div></div></div>
...
<script>
  ...
  export default {
    ...
    created () {
      if (this.$route.params.id) {
        axios.get('proxy/account/approval-entity/' + this.$route.params.id).then((response) => {
          this.entidade = response.data.value.entity
          this.analise = response.data.value
          this.proposta = response.data.value.proposal
          this.dirigentes = this.entidade.chiefs
          this.contato = this.entidade.contact
          this.endereco = this.entidade.address
    ...
    methods: {
      ...
      loadEntityUser () {
        axios.get('proxy/account/entities/' + this.entidade.id + '/users').then((response) => {
      ...
      conclui () {
        ...
        if (entidadeOK) {
          ...
          if (this.$route.params.id) {
            axios.put('/proxy/account/approval-entity/' + this.$route.params.id, this.analise).then((response) => {
              this.salvaUsuarios()
      ...
      loadHistory () {
        axios.get('/proxy/account/entities/' + this.entidade.id + '/history').then((response) => {
