            ...
            <div class="ng-scope ng-isolate-scope">
              ...
              <div class="row">
                <div class="text-left box-header">
                  <a href="" v-if="esconder === false" @click.prevent="esconder = true"><i class="fa fa-caret-down" aria-hidden="true"></i> Mostrar o projeto <span  style="color: steelblue;font-weight: bold;">{{ proposta.idProjectErp }} - {{ proposta.name }}</span></a>
                  <a href="" v-if="esconder === true" @click.prevent="esconder = false"><i class="fa fa-caret-up" aria-hidden="true"></i> Ocultar o projeto <span  style="color: steelblue;font-weight: bold;">{{proposta.idProjectErp }} - {{ proposta.name }}</span></a>
                </div>
              </div>
              <div class="box box-primary"  v-if="esconder === true">
              ...
              <formalizacao :propsAnalise="analise"></formalizacao>
            </div>
          </div>
        </div>
      </section>
...
<script>
  ...
  export default {
    components: {
      ...
      EquipeProjeto,
      PublicoAlvo},
    name: 'main-preparacao-documento',
    data () {
      return {
        loadingShow: false,
        proposta: {
    ...
    methods: {
      buscaAnalise () {
        ...
        axios.get('proxy/project/document-preparation/' + this.$route.params.id).then((response) => {
