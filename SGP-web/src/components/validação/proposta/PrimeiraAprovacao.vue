          ...
          <div class="col-md-12">
            <div class="ng-scope ng-isolate-scope">
              <div class="box box-primary">
                  ...
                  <fieldset :disabled="this.$router.currentRoute.name === 'proposta-visualiza'" >
                    <div class="form-horizontal ng-valid-maxlength ng-invalid ng-invalid-required ng-valid-date ng-invalid-min ng-dirty ng-valid-mask ng-valid-parse">
                              ...
                              <div class="col-md-4">
                                <fieldset :disabled="this.$router.currentRoute.name === 'proposta-visualiza'" >
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('NAME')" class="form-group required-field col-md-12 required"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.name.$error" role="alert">-->
                                ...
                                <fieldset>
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('COORDINATORNAME')"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.coordinatorName.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--<ng-message when="maxlength" class="label label-danger">Tamanho máximo de caracteres: 100</ng-message>-->
                                    <!--</ng-messages>-->
                                  </div>
                                  <div ng-if="regComProFormCtrl.isAval('COORDINATORCPF')"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.coordinatorCpf.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido </ng-message>-->
                                    <!--<ng-message when="maxlength" class="label label-danger">Tamanho máximo de caracteres: 255</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--<ng-message when="validateCpf" class="label label-danger">CPF inválido</ng-message>-->
                                    <!--</ng-messages>-->
                                  </div>
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('COORDINATOREMAIL')"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.coordinatorEmail.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('INITIALDATE')" class=" col-md-12 ng-scope required" style="margin-left: -15px"
                                    ...
                                    <div class="input-group">
                                      <div name="proposal.initialDate" approval="regComProFormCtrl.approval" state="regComProFormCtrl.approvalState" class="ng-isolate-scope">
                                        <datepicker name="Data Inicial" v-model="proposta.initialDate" input-class="form-control datepicker"
                                                    :language="$datePickerPtBR" maxlength="20" :use-utc="true"
                              ...
                              <div v-if="proposta.entityIsExecutioner === false">
                                ...
                                <fieldset class="col-md-4 col-sm-6 col-xs-12">
                                  ...
                                  <div  class="form-group required-field col-md-12"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.entityExecutingCNPJ.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido </ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--<ng-message when="maxlength" class="label label-danger">Tamanho máximo de caracteres: 255 </ng-message>-->
                                    <!--<ng-message when="validateCnpj" class="label label-danger">CNPJ inválido</ng-message>-->
                                    <!--</ng-messages>-->
                                ...
                                <fieldset class="col-md-4 col-sm-6 col-xs-12">
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('ENTITYEXECUTINGMOBILE')" class="form-group required-field col-md-12"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.entityExecutingMobile.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--<ng-message when="maxlength" class="label label-danger">Tamanho máximo de caracteres: 255</ng-message>-->
                                    <!--</ng-messages>-->
                                ...
                                <fieldset class="col-md-4 col-sm-6 col-xs-12">
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('ENTITYEXECUTINGCEP')" class="form-group required-field col-md-12"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.entityExecutingCEP.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--<ng-message when="maxlength" class="label label-danger">Tamanho máximo de caracteres: 255</ng-message>-->
                                    <!--</ng-messages>-->
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('ENTITYEXECUTINGSTATE')"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.entityExecutingState.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--</ng-messages>-->
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('ENTITYEXECUTINGCITY')" class="form-group required-field col-md-12"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.entityExecutingCity.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--<ng-message when="maxlength" class="label label-danger">Tamanho máximo de caracteres: 255</ng-message>-->
                                    <!--</ng-messages>-->
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('ENTITYEXECUTINGADDRESS')" class="form-group required-field col-md-12"
                                    ...
                                    <!--<ng-messages ng-if="frmProposalRegister.$submitted" for="frmProposalRegister.entityExecutingAddress.$error" role="alert">-->
                                    <!--<ng-message when="required" class="label label-danger">Campo requerido</ng-message>-->
                                    <!--<ng-message when="validateChange" class="label label-danger">É necessário corrigir o campo</ng-message>-->
                                    <!--<ng-message when="maxlength" class="label label-danger">Tamanho máximo de caracteres: 255</ng-message>-->
                                    <!--</ng-messages>-->
                      ...
                      <div class="col-md-12">
                        ...
                        <atividades :meses="proposta.periods" :propsObjetivos="proposta.objectives" @metaAdicionada="proposta.objectives = $event" @atv="proposta.objectives = $event"></atividades>
                      </div>
                      ...
                      <div class="col-md-12" v-show="mostraCronograma">
                        ...
                        <cronograma :proposta="proposta" :propsObjetivos="proposta.objectives" :meses="proposta.periods" :atividades="atividades" :componentKey="componentKey" :projeto-duplicacao="proposta.duplicateProject" @itemAdicionado="proposta.objectives = $event"></cronograma>
                      </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <solenizacao :propsSolenizacao="proposta.solemnizations" @solenizacaoAdicionada="proposta.solemnizations = $event"></solenizacao>
                      </div>
                ...
                <pre-analise-form :propsPreAnalise="preAnalise"></pre-analise-form>
              </div>
  ...
  export default {
    ...
    methods: {
      buscaProposta () {
        ...
        axios.get('proxy/project/approval-pre-analysis/' + this.$route.params.id).then((response) => {
          this.proposta = response.data.value.proposal
          this.preAnalise = response.data.value
