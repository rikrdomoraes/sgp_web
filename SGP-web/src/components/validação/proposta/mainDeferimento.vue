        ...
        <div class="row">
          <div class="col-md-12">
            <div class="ng-scope ng-isolate-scope">
                              ...
                              <div class="col-md-7 col-md-offset-1">
                                <div class="col-md-6">
                                  ...
                                  <div ng-if="regComProFormCtrl.isAval('INITIALDATE')" class=" col-md-12 ng-scope required" style="margin-left: -15px"
                                    ...
                                    <label class="control-label">Data inicial aqui</label>
                                    <div class="input-group">
                                      <div name="proposal.initialDate" approval="regComProFormCtrl.approval" state="regComProFormCtrl.approvalState" class="ng-isolate-scope">
                                        <!--<datepicker name="Data Inicial" v-model="proposta.initialDate" :use-utc="true"
              ...
              <deferimento :propsAnalise="analise"></deferimento>
            </div>
          </div>
        </div>
      </section>
...
<script>
  ...
  import Deferimento from './deferimento'
  ...
  export default {
    ...
    methods: {
      buscaAnalise () {
        ...
        axios.get('proxy/project/approval-grant/' + this.$route.params.id).then((response) => {
